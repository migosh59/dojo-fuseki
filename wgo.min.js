/*! MIT license, more info: wgo.waltheri.net */ (function (v, q) {
    ...
    y = function (a) {
      for (var b = a.angle, c = a.angle, e = 0; e < a.lines.length; e++) {
        ...
        var g = g - Math.max(1, d.lineWidth),
          ...
          r = (k = void 0);
        f > l
          ? ((k = (n - h) / (f - l)), (r = Math.atan(k)))
          : f == l
            ? (r = Math.PI / 2)
            : ((k = (n - h) / (f - l)), (r = Math.atan(k) - Math.PI));
        g *= m;
        k = Math.sin(r) * g;
        r = Math.cos(r) * g;
        g = l + k;
          ...
          if (!D(b, a.x, a.y)) {
            ...
            for (e = 0; e < b.obj_list.length; e++)
              ((g = b.obj_list[e]),
                (c = g.handler),
                c.grid &&
                  c.grid.draw.call(b.grid.getContext(g.args), g.args, b));
            delete a._nodraw;
          }
        },
      },
  ...
  h.coordinates = {
    grid: {
      draw: function (a, b) {
        ...
        d = b.getX(-0.75);
        f = b.getX(b.size - 0.25);
        g = b.getY(-0.75);
        h = b.getY(b.size - 0.25);
        for (var l = 0; l < b.size; l++)
          ((c = l + 65),
            73 <= c && c++,
            (e = b.getY(l)),
            this.fillText(b.size - l, d, e),
            this.fillText(b.size - l, f, e),
            (e = b.getX(l)),
            this.fillText(String.fromCharCode(c), e, g),
            this.fillText(String.fromCharCode(c), e, h));
  ...
  h.GridLayer.prototype.draw = function (a) {
    ...
    for (var g = 1; g < a.size - 1; g++)
      ((b = Math.round(a.getX(g)) - a.ls),
        this.context.moveTo(b, e),
        this.context.lineTo(b, e + f),
        (b = Math.round(a.getY(g)) - a.ls),
        this.context.moveTo(c, b),
        this.context.lineTo(c + d, b));
    this.context.stroke();
  ...
  h.MultipleCanvasLayer.prototype.init = function (a) {
    ...
    for (var e = 0; e < a; e++)
      ((b = document.createElement('canvas')),
        (c = b.getContext('2d')),
        1 < this.pixelRatio && c.scale(this.pixelRatio, this.pixelRatio),
  ...
  h.MultipleCanvasLayer.prototype.clear = function (a, b) {
    for (var c = 0; c < this.layers; c++)
      this.contexts[c].clearRect(
        0,
        0,
        this.elements[c].width,
        this.elements[c].height
      );
  };
  ...
  var E = function (a, b) {
    ...
    B = function (a, b) {
      for (var c, e = 0; e < this.obj_arr[a][b].length; e++) {
        ...
        for (var f in c)
          c[f].clear
            ? c[f].clear.call(this[f].getContext(d), d, this)
            : E.call(this[f].getContext(d), d, this);
      }
    },
    x = function (a, b) {
      for (var c, e = 0; e < this.obj_arr[a][b].length; e++) {
    ...
    F = function (a) {
      ...
      a /= this.fieldHeight;
      a = Math.round(a);
      return { x: b >= this.size ? -1 : b, y: a >= this.size ? -1 : a };
    },
    C = function () {
